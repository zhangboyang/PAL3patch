...
#undef LISTNAME
	...
	},
	{
		...
		{
#ifdef BUILD_FOR_PAL3
			{ _T("禁用"), _T("禁用此选项后，存档时将直写存档文件。"), _T("0") },
			{ _T("启用"), _T("启用此选项后，存档时将先写临时文件，再写存档文件。"), _T("1") },
#endif
#ifdef BUILD_FOR_PAL3A
			{ _T("禁用"), _T("禁用此选项后，存档时将直写存档文件；另外，任务列表中的截屏不会随存读档而变化。"), _T("0") },
			{ _T("启用"), _T("启用此选项后，存档时将先写临时文件，再写存档文件；另外，任务列表中的截屏会随存读档而变化。"), _T("1") },
#endif
		}
	},
	{
