...
static struct reg_known_item reg_known[] = {
    { "SOFTWARE\\SOFTSTAR\\PAL3_MOVIE"  , "MOVIE_A"  , 0 , REG_MERGE_OR      },
    { "SOFTWARE\\SOFTSTAR\\PAL3_MOVIE"  , "MOVIE_B"  , 0 , REG_MERGE_OR      },
    { "SOFTWARE\\SOFTSTAR\\PAL3_SAVE"   , "SEEK"     , 0 , REG_MERGE_DISABLE },
    { "SOFTWARE\\SOFTSTAR\\PAL3_S_GAME" , "S_GAME_A" , 0 , REG_MERGE_OR1     },
    { "SOFTWARE\\SOFTSTAR\\PAL3_S_GAME" , "S_GAME_B" , 0 , REG_MERGE_OR1     },
    { "SOFTWARE\\SOFTSTAR\\PAL3_S_GAME" , "S_GAME_C" , 0 , REG_MERGE_OR1     },
    { NULL, NULL } // EOF
};
