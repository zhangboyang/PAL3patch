...
#define PLUGINSYMBOL_ENTRY           pal3apatch_plugin_entry
#define PLUGINSYMBOL_INTERNAL_NAME   pal3apatch_plugin_internalname
#define PLUGINSYMBOL_FRIENDLY_NAME   pal3apatch_plugin_friendlyname
#define PLUGINSYMBOL_VERSION         pal3apatch_plugin_version
#define PLUGINSYMBOL_PLATFORM        pal3apatch_plugin_platform
#define PLUGINSYMBOL_BUILTON         pal3apatch_plugin_builton
#define PLUGINSYMBOL_COMPILER        pal3apatch_plugin_compiler
